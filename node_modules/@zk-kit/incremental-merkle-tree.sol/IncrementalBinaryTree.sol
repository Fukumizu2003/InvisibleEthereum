...
library IncrementalBinaryTree {
    ...
    function initWithDefaultZeroes(IncrementalTreeData storage self, uint256 depth) internal {
        require(depth > 0 && depth <= MAX_DEPTH, "IncrementalBinaryTree: tree depth must be between 1 and 32");
    ...
    function insert(IncrementalTreeData storage self, uint256 leaf) internal returns (uint256) {
